...
const NoticeTable = () => {
  ...
  //render sanitized notice content
  const renderNotice = (noticeContent) => {
    const sanitizedHtml = DOMPurify.sanitize(noticeContent);
              ...
              <div className="shadow-lg card mx-auto w-100">
                <div className=" container d-flex flex-row">
                  <Link
                    ...
                    style={{ width: 190 }}
                    to={"/AdminHome/NoticeTable/NoticeForm"}
                  >
                    Add Announcement &nbsp;
                    ...
                    {notices
                      ...
                      .map((note) => (
                        <tr key={note.id}>
                          <td>{note.faculty}</td>
                          <td>{note.date}</td>
                          <td>{renderNotice(note.topic)}</td>
                          <td>{renderNotice(note.notice)}</td>
                          <td>
                            <Link
